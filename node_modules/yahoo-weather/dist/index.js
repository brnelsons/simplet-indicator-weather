...
function getQueryUri(q) {
  var queryUri = 'http://query.yahooapis.com/v1/public/yql?q=select * from weather.forecast where u=\'f\' AND woeid in (select woeid from geo.places(1) where text="' + q + '")&format=json';
  return queryUri;
}
